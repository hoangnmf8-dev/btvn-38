      ...
      <div className='max-w-350 mx-auto'>
        <div className='flex flex-col gap-13.5'>
          ...
          <div className='flex gap-4'>
            <Card className={cn("p-0 basis-1/6 gap-0")}>
              <AspectRatio ratio={1 / 1} className={cn("w-full")}>
                <img src="/popular_img/Rectangle 13.png" alt="Rectangle_13" className="block w-full h-full rounded-t-md object-cover" />
              </AspectRatio>
            ...
            <Card className={cn("p-0 basis-1/6 gap-0")}>
              <AspectRatio ratio={1 / 1} className={cn("w-full")}>
                <img src="/popular_img/Rectangle 15.png" alt="Rectangle_15" className="block w-full h-full rounded-t-md object-cover" />
              </AspectRatio>
              <CardFooter className={cn("text-web-white flex flex-col justify-center py-3 items-start")}>
            ...
            <Card className={cn("p-0 basis-1/6 gap-0")}>
              <AspectRatio ratio={1 / 1} className={cn("w-full")}>
                <img src="/popular_img/Rectangle 17.png" alt="Rectangle_17" className="block w-full h-full rounded-t-md object-cover" />
              </AspectRatio>
              <CardFooter className={cn("text-web-white flex flex-col justify-center py-3 items-start")}>
            ...
            <Card className={cn("p-0 basis-1/6 gap-0")}>
              <AspectRatio ratio={1 / 1} className={cn("w-full")}>
                <img src="/popular_img/Rectangle 19.png" alt="Rectangle_19" className="block w-full h-full rounded-t-md object-cover" />
              </AspectRatio>
              <CardFooter className={cn("text-web-white flex flex-col justify-center py-3 items-start")}>
            ...
            <Card className={cn("p-0 basis-1/6 gap-0")}>
              <AspectRatio ratio={1 / 1} className={cn("w-full")}>
                <img src="/popular_img/Rectangle 21.png" alt="Rectangle_21" className="block w-full h-full rounded-t-md object-cover" />
              </AspectRatio>
              <CardFooter className={cn("text-web-white flex flex-col justify-center py-3 items-start")}>
            ...
            <Card className={cn("p-0 basis-1/6 gap-0")}>
              <AspectRatio ratio={1 / 1} className={cn("w-full")}>
                <img src="/popular_img/Rectangle 23.png" alt="Rectangle_23" className="block w-full h-full rounded-t-md object-cover" />
              </AspectRatio>
              <CardFooter className={cn("text-web-white flex flex-col justify-center py-3 items-start")}>
